        ...
        <Aux>
            ...
            <div>
                ...
                <Typography className={classes.body} variant="body2">
                    ...
                    Well, In A Nutshell,{' '}
                    <strong>
                        RAGP IS ALL ABOUT YOU (YES, YOU!) BEING ABLE TO LIVE YOUR DREAM LIFESTYLE!!!
                    </strong>
                    <br />
                    <br />
                    It's All About You{' '}
                    <strong>MAKING THE MONEY AND THE TIME To Live The LIFESTYLE</strong> You've
                    Always Dreamt Of and Wanted; But Couldn't LIVE Because You Lacked Two Essential
                    Things: <strong>THE MONEY &amp; THE TIME!!!</strong> Just For A Minute, IMAGINE
                    YOU...(Yes, YOU!):
                    <br />
                    18 Months Later…
                    <br />
                    <br />
                    <strong>
                        Earning &#8358;50k or &#8358;100k As DAILY PASSIVE INCOME, For Sure For
                        Sure!?!?!? YOU CAN:
                    </strong>
                    <br />
