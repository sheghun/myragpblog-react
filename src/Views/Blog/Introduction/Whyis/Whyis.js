...
const Post = (props) => {
    ...
    It's All About You MAKING THE MONEY(N50k or N100k) While You Sleep (DAILY WITH PASSIVE INCONE)
    ...
    **(Tap Here To Join & Start Right Now)
                    ...
                    <br />
                    So, if you're all for that, read on or <a href="http://rechargeandgetpaid.com/register.php">click here </a>
