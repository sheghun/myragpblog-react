...
const UserProfile = (props: any) => {
    ...
    const profileImageUpdateHandler = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        profileImageEl.onload = () => {
            ...
            const profileImageCanvas = document.getElementById(
                'profileImageCanvas',
            ...
            ctx.drawImage(
                ...
                0,
                0,
                profileImageCanvas.width,
                profileImageCanvas.height,
            );
            profileImageCanvas.style.display = 'none';
            profileImageEl.style.display = 'block';

            const compressedImage = profileImageCanvas.toDataURL('image/png', 0.5);
            profileImageCanvas.toBlob(blob => setProfileImage(blob), 'image/png', 0.5);
    ...
    return (
        <>
            ...
            <SnackbarSpinner loading={loading} onClose={() => setLoading(false)} />
                ...
                <GridItem xs={12} sm={12} md={4}>
                    <Card profile={true}>
                        ...
                        <CardBody profile={true}>
                            ...
                            <p className={classes.description}>{inputs.about_me}</p>
                        </CardBody>
                    </Card>
                </GridItem>
