...
const Welcome = loadable(
    () => import("../../Views/Blog/Introduction/Welcome/Welcome"),
    {
        fallback: <Spinner />
    }
);
const WhyIs = loadable(
    () => import("../../Views/Blog/Introduction/Whyis/Whyis"),
    {
        fallback: <Spinner />
    }
);
const WhatIs = loadable(
    () => import("../../Views/Blog/Introduction/Whatis/Whatis"),
    {
        fallback: <Spinner />
    }
);
const CompanyProfile = loadable(
    () => import("../../Views/Blog/Introduction/Company/Company"),
    {
        fallback: <Spinner />
    }
);
const CompensationPlan = loadable(
    () => import("../../Views/Blog/How/Compensation/Compensation"),
    {
        fallback: <Spinner />
    }
);
